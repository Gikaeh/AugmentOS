...
import { CloudToAppMessageType, CloudToGlassesMessageType, GlassesToCloudMessageType } from '../message-types';
...
export interface MediaStateUpdate extends BaseMessage {
  type: CloudToAppMessageType.MEDIA_STATE_UPDATE;
  data: MediaState;
}
...
export interface MediaMetadataUpdate extends BaseMessage {
  type: CloudToAppMessageType.MEDIA_METADATA_UPDATE;
  data: MediaMetadata;
}
...
export interface MediaSessionEndedUpdate extends BaseMessage {
  type: CloudToAppMessageType.MEDIA_SESSION_ENDED_UPDATE;
...
export function isMediaStateUpdate(message: CloudToAppMessage): message is MediaStateUpdate {
  return message.type === CloudToAppMessageType.MEDIA_STATE_UPDATE;
}

export function isMediaMetadataUpdate(message: CloudToAppMessage): message is MediaMetadataUpdate {
  return message.type === CloudToAppMessageType.MEDIA_METADATA_UPDATE;
}

export function isMediaSessionEndedUpdate(message: CloudToAppMessage): message is MediaSessionEndedUpdate {
  return message.type === CloudToAppMessageType.MEDIA_SESSION_ENDED_UPDATE;
}
