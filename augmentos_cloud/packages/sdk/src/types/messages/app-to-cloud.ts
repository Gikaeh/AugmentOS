...
export interface MediaControlCommand extends BaseMessage {
  type: AppToCloudMessageType.PHONE_MEDIA_CONTROL;
 ...
 */
export function isMediaControlCommand(message: AppToCloudMessage): message is MediaControlCommand {
  return message.type === AppToCloudMessageType.PHONE_MEDIA_CONTROL;
}
